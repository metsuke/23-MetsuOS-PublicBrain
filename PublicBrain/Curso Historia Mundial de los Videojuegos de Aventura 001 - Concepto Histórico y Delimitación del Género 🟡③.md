...
modified: 2026-03-21T06:43:16.172Z
supervisado: ""
ACCION: ""
ver_major: 0
ver_minor: 2
...
- **El legado de `ADVENT`:** En 1976, Will Crowther escribió _Colossal Cave Adventure_. En los sistemas de la época, el ejecutable se llamaba simplemente `ADVENT`. El impacto fue tan profundo en la comunidad universitaria de ARPANET que los juegos similares empezaron a llamarse "juegos tipo Adventure".
    
- **La transición del rol de mesa:** El género surge como la respuesta digital a _Dungeons & Dragons_. Sin embargo, el videojuego de aventura decidió sacrificar la aleatoriedad de los dados y la complejidad de las hojas de personaje para priorizar la **lógica situacional** y la exploración del entorno.
...
En la aventura, la historia no es un marco decorativo. Es el motor que justifica cada acción. Mientras que en un _shooter_ el jugador avanza "limpiando" una zona de enemigos, en la aventura el jugador avanza "desbloqueando" fragmentos de información o contextos.
...
- **Gestión de Inventario:** El uso de objetos recolectados de forma creativa (lógica de _objetos y verbos_).
    
- **Bloqueos Cognitivos:** El progreso se detiene ante un problema que requiere deducción, no velocidad de reacción.
...
|---|---|---|
|**Aventuras de Texto**|_Parser_|Interacción mediante lenguaje natural escrito.|
