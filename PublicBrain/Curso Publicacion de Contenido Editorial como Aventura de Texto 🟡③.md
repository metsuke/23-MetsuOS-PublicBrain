...
nav_secondary: []
tags: []
MOS_TopImg_Video: ContenidoEditorialComoAventuraTexto_000.mp4
---
...
- **Lección 1.1: Definición y características básicas**  
...
- **Lección 2.1: Orígenes en la era retro**  
...
- **Lección 3.1: Estructura de una aventura de texto**  
...
- **Lección 4.1: Emuladores y software retro**  
...
- **Lección 5.1: Herramientas web y de código abierto**  
...
- **Lección 6.1: Principios de multimedia en aventuras de texto**  
...
- **Lección 7.1: Preparación del contenido**  
...
- **Lección 8.1: Proyecto 1: Post interactivo retro**  
...
1. [Montfort, Nick. (2013). Riddle Machines: The History and Nature of Interactive Fiction. MIT Open Access Articles. 🟡③🌐](https://dspace.mit.edu/bitstream/handle/1721.1/129076/Montfort-Riddle-Machines.pdf) .- Artículo académico de Nick Montfort sobre la historia y naturaleza de la ficción interactiva (aventuras de texto), accesible como PDF abierto en el repositorio DSpace del MIT.
2. [Nelson, Graham. The Craft of Adventure. Disponible en el Interactive Fiction Archive 🟡③🌐](https://ifarchive.org/if-archive/info/Craft.Of.Adventure.pdf) .- Ensayo clásico de Graham Nelson (edición de 1995) sobre el diseño de aventuras conversacionales y ficción interactiva, disponible como PDF en el IF Archive.
3. ["Elige tu propia aventura: breve historia de la hiperficción". (Sin fecha específica). El Templo de las Mil Puertas. 🟡③🌐](https://www.eltemplodelasmilpuertas.com/reportaje/elige-tu-propia-aventura-breve-historia-hiperficcion/387) .- Artículo en El Templo de las Mil Puertas que ofrece una breve historia de la hiperficción y el formato "Elige tu propia aventura", desde sus orígenes literarios hasta ejemplos modernos.
4. [Chinchilla, Chris. (2021). "The past, present, and future of interactive fiction". 🟡③🌐](https://www.youtube.com/watch?v=rYs6HM8ly40) .- Vídeo de Chris Chinchilla (publicado en 2023, aunque titulado como 2021 en referencias) que repasa el pasado, presente y futuro de la ficción interactiva, incluyendo choose-your-own-adventure, Infocom, Twine y obras modernas.
5. ["Interactive Fiction". (2023). Wikipedia.  (sección sobre el resurgimiento en comunidades online) 🟡③🌐](https://en.wikipedia.org/wiki/Interactive_fiction) .- Entrada de Wikipedia en inglés sobre ficción interactiva, con sección específica sobre su resurgimiento en comunidades online desde los años 80-90 hasta la era actual.
