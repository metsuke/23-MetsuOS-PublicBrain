...
modified: 2026-06-04T01:36:49.621Z
supervisado: ""
ACCION: ""
ver_major: 0
ver_minor: 2
...
nav_secondary: []
tags: []
MOS_TopImg_Video: BibliotecaArchiveroRetro000[D].mp4
---
...
## Historia - Plataformas de Videojuegos

Desde el primer sistema de videojuegos hasta lo más reciente y puntero, ¡Explora la historia del mundo del video juego a través de sus plataformas!

Continua leyendo en ... [[Biblioteca del Retro - Historia de las Plataformas de Videojuegos  ⚫①]]
...
1. [Video Game History Foundation Library (2025). 🟡③🌐](https://library.gamehistory.org/) .- Biblioteca digital pública del Video Game History Foundation con miles de revistas escaneadas, materiales de desarrollo, arte y ephemera de videojuegos, abierta en acceso temprano para investigadores y aficionados.
2. [library.gamehistory.org — Now in early access 🟡③🌐 🟡③🌐](https://www.youtube.com/watch?v=6Tysm_Wf60Q) .- Vídeo de presentación que anuncia el lanzamiento en acceso temprano de la biblioteca digital de la Video Game History Foundation, con miles de materiales históricos de videojuegos como revistas, documentos de desarrollo y arte.
3. [Preservación de videojuegos - Wikipedia (actualizado 2026). 🟡③🌐](https://es.wikipedia.org/wiki/Preservaci%C3%B3n_de_videojuegos) .- Resumen enciclopédico de iniciativas globales para recopilar juegos, hardware y documentación asociada de sistemas obsoletos.
4. [Kent, Steven L. (2001). *La Gran Historia de los Videojuegos*. 🟡③🌐](https://archive.org/details/368624345KentStevenL2001LaGranHistoriaDeLosVideojuegos) .- Compilación exhaustiva de la evolución industrial, disponible en formato digital preservado.
5. [Recreativas.org 🟡③🌐](https://www.recreativas.org/) .- Base de datos dedicada a máquinas recreativas españolas, con fichas detalladas, imágenes y documentos históricos.
...
1. [IGDA Game Preservation SIG (2009). *Before It's Too Late: A Digital Game Preservation White Paper*. 🟡③🌐](https://files.eric.ed.gov/fulltext/EJ1069232.pdf) .- White paper del IGDA Game Preservation SIG (2009) que expone problemas críticos como obsolescencia de hardware/software, derechos de autor que impiden emulación y migración, y dependencia de servidores remotos, alertando sobre pérdidas irreversibles de juegos y su legado cultural.
2. [Alcaraz, R. (2013). *Game Over? El reto de la preservación digital de los videojuegos*. 🟡③🌐](https://www.rubenalcaraz.es/pinakes/preservacion-digital/game-over-el-reto-de-la-preservacion-digital-de-los-videojuegos) .- Análisis de dificultades en la emulación de consolas y software, subrayando la fragilidad de los artefactos digitales en capas físicas, lógicas, conceptuales y esenciales según UNESCO.
3. MAYBE TO DELETE OR REVIEW MANUALLY -[Garda, M. B. et al. (2025). *Video Game Preservation and Its Challenges*. 🟡③🌐](https://www.researchgate.net/publication/393426766_Video_Game_Preservation_and_Its_Challenges) .- Estudio académico sobre barreras únicas, como la complejidad de artefactos born-digital y la imposibilidad de abarcar todos los variantes. MAYBE TO DELETE OR REVIEW MANUALLY – Wayback failed on all attempted URLs
4. [El Inevitable fin de los videojuegos | La preservación (2023). 🟡③🌐](https://www.youtube.com/watch?v=8xIstQ5YmoM) .- Vídeo que argumenta la ineficacia de los esfuerzos actuales de preservación de videojuegos digitales y físicos, prediciendo un colapso inevitable por obsolescencia, cambios en licencias, servidores y preferencias culturales.
