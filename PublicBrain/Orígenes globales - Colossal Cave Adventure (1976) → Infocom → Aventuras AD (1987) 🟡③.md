...
nav_secondary: []
tags: []
MOS_TopImg_Video: HistoriaAventuras_000.mp4
---
...
Puedes consultar [los archivos de CAAD 🟡③🌐](https://ifarchive.org/if-archive/magazines/CAAD/). Te invito a jugar originales en emuladores y sentir el bruto encanto.

## Referencias Bibliográficas que Apoyan

1. [Colossal Cave Adventure - Wikipedia 🟡③🌐](https://en.wikipedia.org/wiki/Colossal_Cave_Adventure) .- Artículo exhaustivo sobre su creación por Crowther (1975-76) y expansión por Woods (1977), con detalles técnicos y distribución por ARPANET.
2. [Infocom - Wikipedia 🟡③🌐](https://en.wikipedia.org/wiki/Infocom) .- Historia completa de la fundación en 1979 por exalumnos del MIT, Zork y quiebra en 1989.
3. [Aventuras AD - Wikipedia 🟡③🌐](https://es.wikipedia.org/wiki/Aventuras_AD) .- Entrada que detalla su origen en 1987 como filial de Dinamic, juegos clave y uso de DAAD.
...
2. [Adventure game - Wikipedia 🟡③🌐](https://en.wikipedia.org/wiki/Adventure_game) .- Señala precursores como Hunt the Wumpus (1973) y elementos en juegos anteriores, sugiriendo una evolución gradual más que un origen único en 1976.
3. [Hunt the Wumpus, Part 1 | The Digital Antiquarian 🟡③🌐](https://www.filfre.net/2011/05/hunt-the-wumpus-part-1/) .- Análisis que posiciona Hunt the Wumpus como influencia temprana en exploración textual, relativizando el impacto exclusivo de Adventure.
4. [History of Interactive Fiction in Spain - IFWiki 🟡③🌐](https://www.ifwiki.org/History_of_Interactive_Fiction_in_Spain) .- Historia española que enfatiza desarrollos locales independientes, minimizando la influencia directa de Infocom en el auge AD.
5. [De cómo evolucionó el aspecto del fanzine - Club de Aventuras AD 🟡③🌐](https://caad.club/de-como-evoluciono-el-aspecto-del-fanzine/) .- Artículo oficial de CAAD que data su fundación en 1988, pero menciona transiciones que algunos interpretan como inicio efectivo en 1989.
